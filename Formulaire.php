...
<head>
    ...
    <link rel="stylesheet" href="style_formulair.css">
    <script src="https://kit.fontawesome.com/6f7568c507.js" crossorigin="anonymous"></script>
</head>
<body>
    <header class="head">
        <nav>
            <h1 id="logo"><img src="Logo.jpg" alt=""></h1>
                <ul>
                    <li><a href="#"><i class="fa-solid fa-face-laugh-beam"></i> Activités</a></li>
                    <li><a href="#"><i class="fa-solid fa-comment-dots"></i> Contact-nous</a></li>
